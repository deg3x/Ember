...
#define RENDERER_VK_FRAMES_IN_FLIGHT 2
...
struct renderer_t
{
    ...
    VkCommandBuffer         command_buffers[RENDERER_VK_FRAMES_IN_FLIGHT];
    VkSemaphore             sem_img_avail[RENDERER_VK_FRAMES_IN_FLIGHT];
    VkSemaphore             sem_render_end[RENDERER_VK_FRAMES_IN_FLIGHT];
    VkFence                 fence_in_flight[RENDERER_VK_FRAMES_IN_FLIGHT];
